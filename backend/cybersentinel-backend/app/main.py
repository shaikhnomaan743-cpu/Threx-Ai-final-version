...
def create_app() -> FastAPI:
    ...
    # 127.0.0.1 and localhost are distinct origins to the browser, so both
    # spellings of every dev port must be listed or the UI fails CORS silently.
    cors_origins = [
        "http://localhost:5173", "http://127.0.0.1:5173",   # vite dev
        "http://localhost:4173", "http://127.0.0.1:4173",   # vite preview
        "http://localhost:3000", "http://127.0.0.1:3000",   # nginx / docker
    ]
